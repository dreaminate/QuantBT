...
const OVERVIEW_LEGEND_TOP = 2;
/** 与 legendTop 一起参与 gridTop0，一般很小即可 */
const OVERVIEW_LEGEND_BLOCK = 4;
/** 三个子图之间的竖向间距（px） */
const OVERVIEW_GRID_GAP = 8;
/** 底部时间轴 slider 高度（px） */
const OVERVIEW_SLIDER_H = 26;
/** slider 距容器底边（px） */
const OVERVIEW_SLIDER_BOTTOM = 4;

/** —— 自行改这三项即可调三图相对高度（像素）—— */
const MAIN_CHART_HEIGHT_PX = 280;
const DAILY_CHART_HEIGHT_PX = 120;
const TRADE_CHART_HEIGHT_PX = 120;
