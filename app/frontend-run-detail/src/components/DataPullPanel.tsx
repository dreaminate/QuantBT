        ...
        {market === "binanceusdm" ? (
          <div className="data-pull-full-banner panel-soft" style={{ marginBottom: "1rem", padding: "0.75rem 1rem", borderRadius: "8px" }}>
            <p style={{ margin: "0 0 0.5rem", fontSize: "0.9rem", lineHeight: 1.5 }}>
              一键按顺序全量拉取<strong>全部加密 data_kind</strong>：Vision 覆盖 data.binance.vision 下 USDM/CM 日频、现货日频、期权 BVOL/EOH；REST 为 USDT 永续。
              ...
              下方可选一键使用的周期；<code>1m</code> 等比 <code>1h</code> 量大得多。任务可能极长，请勿关闭标签。
            </p>
