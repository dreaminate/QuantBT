...
type DomainTab = "cn_stock" | "hk_stock" | "us_stock" | "crypto" | "browser" | "jobs" | "sources" | "fields";
type DataBrowserBucketId = "cn" | "hk" | "us" | "crypto";

type DomainConfig = {
  key: Exclude<DomainTab, "browser" | "jobs" | "sources" | "fields">;
  label: string;
  pullMarkets: string[];
};
...
const DOMAIN_TAB_ORDER: DomainTab[] = ["cn_stock", "hk_stock", "us_stock", "crypto", "sources", "fields", "browser", "jobs"];
...
function DataBrowserView({
  ...
  return (
    <div className="data-browser-root">
      <p className="inline-note muted data-browser-hint">选择数据集与文件后，可以直接预览 CSV 前 20 行。</p>
      ...
      <div className="data-browser-columns">
        <section className="panel data-browser-col">
      ...
      <section className="panel panel-soft data-browser-preview">
        <div className="panel-header">
          <div>
