...
type DomainTab = "cn_stock" | "hk_stock" | "us_stock" | "crypto" | "browser" | "jobs" | "fields";
...
const DOMAIN_TAB_ORDER: DomainTab[] = ["cn_stock", "hk_stock", "us_stock", "crypto", "fields", "browser", "jobs"];
